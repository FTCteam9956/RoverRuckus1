//Read Vuforia
//Read ball and hit correct one off
//drive over to the wall
//Move the arm at an angle and detect the color/distance of the pylons
//when at the correct pylon turn and angle the block in the hole
//open the claw and turn away
//Eventually turn back to the pile and grab extra blocks for extra points
...
@Autonomous(name = "NewRedStraight", group = "Autonomous")
@Disabled
public class NewRedStraight extends LinearOpMode {
